...
export const Dog = forwardRef(({seed}, ref) => {
    ...
    switch(seed){
        ...
        case 4:  return  <div ref={ref} ><Dog9 className={`background_dog show`}/><Dog9_2  className={`background_dog hide`}/></div>
        case 5:  return  <div ref={ref} ><Dog5 className={`background_dog show`}/><Dog5_2  className={`background_dog hide`}/></div>
        case 6:  return  <div ref={ref} ><Dog6 className={`background_dog show`}/><Dog6_2  className={`background_dog hide`}/></div>
        case 7:  return  <div ref={ref} ><Dog7 className={`background_dog show`}/><Dog7_2  className={`background_dog hide`}/></div>
        case 8:  return  <div ref={ref} ><Dog8 className={`background_dog show`}/><Dog8_2  className={`background_dog hide`}/></div>
...
export const FooterDogs = ({seed}) => {
    console.log(seed)
    switch(seed){
        case 1:  return  <div className="footerDog"><Dog2_2/><Dog3_2/><Dog9_2/><Dog5_2/><Dog6_2/><Dog7_2/><Dog8_2/></div>
        case 2:  return  <div className="footerDog"><Dog1_2/><Dog3_2/><Dog9_2/><Dog5_2/><Dog6_2/><Dog7_2/><Dog8_2/></div>
        case 3:  return  <div className="footerDog"><Dog1_2/><Dog2_2/><Dog9_2/><Dog5_2/><Dog6_2/><Dog7_2/><Dog8_2/></div>
        case 4:  return  <div className="footerDog"><Dog1_2/><Dog2_2/><Dog3_2/><Dog5_2/><Dog6_2/><Dog7_2/><Dog8_2/></div>
        case 5:  return  <div className="footerDog"><Dog1_2/><Dog2_2/><Dog3_2/><Dog9_2/><Dog6_2/><Dog7_2/><Dog8_2/></div>
        case 6:  return  <div className="footerDog"><Dog1_2/><Dog2_2/><Dog3_2/><Dog9_2/><Dog5_2/><Dog7_2/><Dog8_2/></div>
        case 7:  return  <div className="footerDog"><Dog1_2/><Dog2_2/><Dog3_2/><Dog9_2/><Dog5_2/><Dog6_2/><Dog8_2/></div>
        case 8:  return  <div className="footerDog"><Dog1_2/><Dog2_2/><Dog3_2/><Dog9_2/><Dog5_2/><Dog6_2/><Dog7_2/></div>
        default: return  <div className="footerDog"><Dog1_2/><Dog2_2/><Dog3_2/><Dog9_2/><Dog5_2/><Dog6_2/><Dog7_2/></div>
    }
};